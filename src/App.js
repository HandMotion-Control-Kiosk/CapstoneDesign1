...
import FingerTwo from "./FingerTwo.png";
...
function App() {
  ...
  const images_t = { FingerOne: set1,FingerTwo: burger1, FingerThree:side1, FingerFour:drink};  ////////
    ...
    if (
      ...
      if (hand.length > 0) {
        ...
        if (gesture.gestures !== undefined && gesture.gestures.length > 0) {
          ...
          // 병현 수정 , prestate로 손동작 바뀌면 handposecount 0
          if(state != prestate){
            Handpose_count = 0;
          }
          prestate = gesture.gestures[maxConfidence].name;
          Handpose_count++;
          

          // 손바닥일 경우 submain 출력
          // 병현 수정 장바구니 submain 부터 출력
          if(state == "FingerFive" && Benercount==0 && Handpose_count > 30){
            // submain 출력
            setSubmain(state);
          ...
          if(Benercount == 1 && Handpose_count > 30){
          ...
          if(Benercount ==2  && Handpose_count>30){
          ...
          // 병현 수정 , handpose count 15에서 30으로 바꿈
          if(Benercount ==3  && Handpose_count>30){
            if(state == "Fist") {
          ...
          // if(state == "FingerTwo" ){
          //   console.log("state FingerTwo체크", state)
    ...
    <div className="App">
      <header className="App-header">
        ...
        {/* <div id="confirm"  style={{
          ...
          선택하신 메뉴를 결제 하시겠습니까?
            <div><img src={ok} style={{width: "5%"}}></img>Yes &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src={FingerTwo} style={{width: "5%"}}></img>No</div>
        </div>  */}
